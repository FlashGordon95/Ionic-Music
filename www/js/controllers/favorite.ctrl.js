// Playlist special
angular.module('cosmic.controllers').controller('FavoriteCtrl', function($scope, $stateParams, $state,cosmicDB,cosmicPlayer,$ionicViewSwitcher,$ionicGesture,cosmicConfig,$ionicPopover,$cordovaToast,$ionicListDelegate,$localstorage) {
